  ...
  module ConfigHelper
    ...
    def casein_config_hostname
      if Rails.env.production?
        'http://www.chinesecookingathome.com'
      else
        'http://0.0.0.0:3000'
      end
    end
    ...
    def casein_config_email_from_address
      'donotreply@chinesecookingathome.com'
    end
    ...
    def casein_config_stylesheet_includes
      %w[casein/casein casein/custom jquery-ui bootstrap-wysihtml5/bootstrap3-wysihtml5]
    end
    ...
    def casein_config_javascript_includes
      %w[casein/casein casein/custom jquery-ui bootstrap-wysihtml5 bootstrap-wysihtml5/locales]
    end
